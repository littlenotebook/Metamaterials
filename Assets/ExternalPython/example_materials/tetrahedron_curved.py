...
for n1 in range(4):
    for n2 in range(n1+1, 4):
        ...
        params = (node_positions[n1] + node_positions[n2] + 0.5*2) / 4 - node_positions[n1]
        edge_params[edge_index : edge_index+EDGE_BEZIER_COORDS//2] = params
        edge_params[edge_index+EDGE_BEZIER_COORDS//2 : edge_index+EDGE_BEZIER_COORDS] = params
...
TETRAHEDRON_CURVED = Metamaterial(node_pos, edge_adj, edge_params, face_adj, face_params, thickness=0.5)