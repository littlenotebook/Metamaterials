...
node_positions = np.array([
    ...
    # [1., 0., 0.],
    # [1., 0., 1.],
    # [0., 0., 0.], # do i have to follow the path of the shape and repeat nodes?
    # [0., 1., 1.],
    # [0., 1., 0.],

    # [0., 0., 0.],
    # [1., 1., 0.],
    # [1., 1., 1.], # ends up as 48 nodes
...
# for n1 in range(4):
#     for n2 in range(n1+1, 4): # creates edges all from single source node
...
for n1 in range(4): # creates edges from previous node
    n2 = (n1+1)%4
    n1,n2 = sorted((n1,n2))
...
PERSONAL_WIREFRAME = Metamaterial(node_pos, edge_adj, edge_params, face_adj, face_params, thickness=0.5)